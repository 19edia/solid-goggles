...
export function allianceMessage(d,invite){
 return {embeds:[new RokuharaEmbed(d.id).setTitle('ROKUHARA × RYUKETSU').setDescription([
 '🤝 **NOSSA ALIANÇA**',
 'A **RYUKETSU BR** é uma gang aliada da **ROKUHARA**. Valorizamos essa parceria e queremos fortalecer os laços entre nossas comunidades com respeito e união.',
